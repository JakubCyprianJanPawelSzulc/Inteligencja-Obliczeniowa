...
dtc_small = DecisionTreeClassifier(max_depth=3, random_state=2137)
dtc_large = DecisionTreeClassifier(random_state=2137)
gnb = GaussianNB()
knn = KNeighborsClassifier(n_neighbors=5)
mlp = MLPClassifier(hidden_layer_sizes=(10,), max_iter=1000, random_state=2137)
...
print('Dokładność: {:.2f}%'.format(accuracy_score(y_test, y_pred_dtc_small)*100))
print('Macierz błędu:\n', cm_dtc_small)
print('Dokładność: {:.2f}%'.format(accuracy_score(y_test, y_pred_dtc_large)*100))
print('Macierz błędu:\n', cm_dtc_large)
print('Dokładność: {:.2f}%'.format(accuracy_score(y_test, y_pred_gnb)*100))
print('Macierz błędu:\n', cm_gnb)
print('Dokładność: {:.2f}%'.format(accuracy_score(y_test, y_pred_knn)*100))
print('Macierz błędu:\n', cm_knn)
print('Dokładność: {:.2f}%'.format(accuracy_score(y_test, y_pred_mlp)*100))
print('Macierz błędu:\n', cm_mlp)
